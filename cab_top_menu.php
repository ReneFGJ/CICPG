...
<ul id="gn-menu" class="gn-menu-main"> 
					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller"> 
							<ul class="gn-menu">
								...
								<li> <a href="programacao.php"><i class="fa fa-calendar faIcon"></i> Minha Agenda <span style="font-size: 10px;">(em breve)</span></a></li>
				...
				<li><a class="codrops-icon codrops-icon-prev" href=""><span>Minha Agenda <span style="font-size: 8px;">(em breve)</span></span></a></li>
