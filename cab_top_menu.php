					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller"> 
							<ul class="gn-menu">
								...
								<li> <a href="instituicoesparticipantes.php"><i class="fa fa-university"></i> Instuituições Participantes</a></li>
								<li> <a href="submissao-de-trabalhos.php"><i class="fa fa-file"></i> Submissão de trabalhos</a></li>
								<li> <a href="instrucoes-para-autores.php"><i class="fa fa-pencil-square-o"></i> Instruções para Autores</a></li>
								...
								<li> <a href="calendario.php"><i class="fa fa-calendar"></i> Calendário</a></li>
								<li> <a href="sobre-curitiba.php"><i class="fa fa-bus"></i> Sobre Curitiba</a></li>
								<li> <a href="mapas.php"><i class="fa fa-map-marker"></i> Mapas</a></li>
								<li> <a href="comissoes.php"><i class="fa fa-users"></i> Comissões</a></li>
								<li> <a href="galeria-de-homenageados.php"><i class="fa fa-star"></i> Galeria de Homenageados</a></li>
